...
public class Level2 extends AppCompatActivity {
    ...
    String quizData[][] = {
            ...
            {"Is Dementia part of ageing?", "No", "Yes", "Don't Know"},
            {"Option below are cause by ageing except?", "ADHD", "Weakling Bones", "Mispalcing Object"},
            {"Below show symptoms of Dementia except", "Insomnia", "Lacking of Problem Solving", "Forgot family's name"},
            {"How is Dementia Diagnosed", "Brain Scan", "Urinalysis", "CPR"}
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countLabel = (TextView) findViewById(R.id.LV2Page);
        questionLabel = (TextView) findViewById(R.id.LV2Question);
        ansBut1 = (Button) findViewById(R.id.LV2But1);
        ansBut2 = (Button) findViewById(R.id.Lv2But2);
        ansBut3 = (Button) findViewById(R.id.LV2But3);
    ...
    public void checkAnswer(View view){
        ...
        if (btnText.equals(rightAns)){
            ...
            progressRef.child("quiz2").setValue(50); // 50% progress
